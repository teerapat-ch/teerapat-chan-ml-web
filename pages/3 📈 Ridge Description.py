...
st.write("ในการหาค่าจะใช้ Linear Regression")
st.latex("y = w_1x_1 + w_2x_2 +\cdots+w_nx_n + b")
st.latex("y = ค่าผลลัพธ์ที่ต้องการพยากรณ์")
st.latex("x_1,x_2,\cdots,x_n = ฟีเจอร์ของข้อมูล")
st.latex("w_1,w_2,\cdots,w_n = ค่าสัมประสิทธิ์ (weights) ที่โมเดลต้องเรียนรู้")
st.latex("b = ค่าคงที่ (bias)")

st.write("ใน Ridge Regreession จะทำการเพิ่ม penalty เข้าไป")
st.latex("Loss Function = \sum_{i=1}^{n} (y-\hat{y})^2 + λ\sum_{j=1}^{p} β^2_j")
st.latex("y_i = ค่าจริงของตัวแปรที่ต้องการทำนาย")
st.latex("\hat{y_i} = คือค่าที่ได้จากการทำนายของโมเดล")
st.latex("β_j = คือค่าสัมประสิทธิ์ของตัวแปร\quad j")
st.latex("n = คือจำนวนตัวอย่าง")
st.latex("p = คือจำนวน\quad features")
st.latex("λ = คือพารามิเตอร์ที่ควบคุมขนาดของ\quad penalty")
